...
export const TOOL_DEFINITIONS: ToolDefinition[] = [
  ...
  },
  {
    href: "/geez-numbers",
    title: "Ge'ez Numbers",
    description: "Convert numbers and dates to traditional Ethiopic Ge'ez numerals.",
    navDescription: "Numeral converter",
    titleKey: "nav.geezNumbers",
    descriptionKey: "nav.geezNumeralsDesc",
    icon: Hash,
  ...
  },
  {
    href: "/business-days",
    title: "Business Days",
    description: "Calculate working days excluding Ethiopian public holidays and tax deadlines.",
    navDescription: "Working days & tax",
    titleKey: "nav.businessDays",
    descriptionKey: "nav.businessDaysDesc",
    icon: Briefcase,
  ...
  },
  {
    href: "/world-clock",
    title: "World Clock",
    description: "Compare Ethiopian 12-hour clock side-by-side with global diaspora cities.",
    navDescription: "Dual-time diaspora clock",
    titleKey: "nav.worldClock",
    descriptionKey: "nav.worldClockDesc",
    icon: Globe2,
